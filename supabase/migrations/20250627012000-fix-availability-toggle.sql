...
-- Fix the availability toggle issue in get_companion_time_slots function
...
BEGIN
    ...
    -- If has specific slots, return ALL slots (both available and unavailable for debugging)
