...
-- Fix the get_companion_time_slots function to return ALL specific slots for proper processing
...
BEGIN
    ...
    -- If has specific slots, return ALL slots (both available and unavailable)
